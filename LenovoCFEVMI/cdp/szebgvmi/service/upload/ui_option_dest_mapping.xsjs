...
/*	var info_sql = 'call "SZEBGVMI"."cdp.szebgvmi.procedures.pkg_ui.upload::ui_option_dest_mapping_err"(\''
		+error_message+'\',\''
		+fileName+'\',\''
...
if(lib.assertAppRole(role)==='OK')
{
	...
	/*	query = 'CALL "SZEBGVMI"."cdp.szebgvmi.procedures.pkg_ui.upload::ui_option_dest_mapping"'
		    + '(\''
