...
function validationBefore(param,oper_type){
    ...
    pStmt = param.connection.prepareCall('call "cdp.mxebgvmi.procedures.pkg_ui.ui_source_priority::validationSourcePriority"(?,?,?,?,?,?,?,?,?,?)');
...
function insert(param){
    ...
    pStmt = param.connection.prepareCall('call "cdp.mxebgvmi.procedures.pkg_ui.ui_source_priority::createSourcePriority"(?,?,?,?,?,?,?,?)');
    pStmt.setNString(1,LOGICAL_PLANT);
	pStmt.setNString(2,MO_TYPE);
	pStmt.setNString(3,WAREHOUSE_NUMBER);
	pStmt.setNString(4,STORAGE_LOCATION);
...
function update(param){
    ...
    pStmt = param.connection.prepareCall('call "cdp.mxebgvmi.procedures.pkg_ui.ui_source_priority::updateSourcePriority"(?,?,?,?,?,?,?,?)');
    pStmt.setNString(1,LOGICAL_PLANT);
	pStmt.setNString(2,MO_TYPE);
	pStmt.setNString(3,WAREHOUSE_NUMBER);
	pStmt.setNString(4,STORAGE_LOCATION);
...
function remove(param){
    ...
    pStmt = param.connection.prepareCall('call "cdp.mxebgvmi.procedures.pkg_ui.ui_source_priority::deleteSourcePriority"(?,?,?,?,?)');
    pStmt.setNString(1,LOGICAL_PLANT);
	pStmt.setNString(2,MO_TYPE);
	pStmt.setNString(3,WAREHOUSE_NUMBER);
	pStmt.setNString(4,STORAGE_LOCATION);
