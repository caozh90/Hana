...
function validationBefore(param,oper_type){
    ...
    pStmt = param.connection.prepareCall('call "cdp.mxebgvmi.procedures.pkg_ui.ui_urgent_mo_maintence::validationUrgentMoMaintence"(?,?,?,?,?,?,?,?,?,?,?,?)');
...
function insert(param){
    ...
    pStmt = param.connection.prepareCall('call "cdp.mxebgvmi.procedures.pkg_ui.ui_urgent_mo_maintence::createUrgentMoMaintence"(?,?,?,?,?,?,?,?,?,?)');
    pStmt.setNString(1,LOGICAL_PLANT);
	pStmt.setNString(2,DS_LINE);
	pStmt.setNString(3,MO_ID);
	pStmt.setNString(4,BOM_NAME);
...
function update(param){
    ...
    pStmt = param.connection.prepareCall('call "cdp.mxebgvmi.procedures.pkg_ui.ui_urgent_mo_maintence::updateUrgentMoMaintence"(?,?,?,?,?,?,?,?,?)');
    pStmt.setNString(1,LOGICAL_PLANT);
	pStmt.setNString(2,DS_LINE);
	pStmt.setNString(3,MO_ID);
	pStmt.setNString(4,BOM_NAME);
...
function remove(param){
    ...
    pStmt = param.connection.prepareCall('call "cdp.mxebgvmi.procedures.pkg_ui.ui_urgent_mo_maintence::deleteUrgentMoMaintence"(?)');
