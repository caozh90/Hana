...
sap.ui.jsview("lenovo.view.vmi.control.optionDestinationMapping", {
	...
	setConfig: function(config, sServiceUrl, uServiceUrl,dSchema) {
		...
		config.download.table = '"_SYS_BIC"."cdp.mxebgvmi.models/AT_OPTION_DEST_MAPPING"';
		...
		config.upload = {
			...
			excelUrl: "vmi/control/option_destination_mapping.xlsx"
		};
