...
sap.ui.jsview("lenovo.view.vmi.control.controlCycle", {
	...
	setConfig: function(config, sServiceUrl, uServiceUrl, dSchema) {
		...
		config.download.table = '"_SYS_BIC"."cdp.mxebgvmi.models/AT_UI_CONTROL_CYCLE"';
		...
		config.insertRaw = [{
			...
			dropdowntable: {
				...
				defaultFilterOp: "EQ",
				url: sServiceUrl,
				bindRowUrl: "/UI_WAHREHOUSE?$select=WHS_NO,WERKS",
				fields: [{
		...
		config.upload = {
			...
			excelUrl: "vmi/control/control_cycle.xlsx"
		};
