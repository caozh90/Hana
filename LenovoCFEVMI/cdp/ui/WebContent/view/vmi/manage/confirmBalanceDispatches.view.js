...
sap.ui.jsview("lenovo.view.vmi.manage.confirmBalanceDispatches", {
	setConfig: function(config,sServiceUrl) {
		...
		config.download.table = '"_SYS_BIC"."cdp.mxebgvmi.models/CV_CONFIRM_BALANCE_DISPATCHES"';
		...
		var oInvokeBtn = new sap.ui.commons.Button({
			...
			press: function(oEvent){
				...
				var oEntry = {
					...
					"PROCESS_NAME": "BALANCE_PULL_TO_ECC",
					"TABLE_NAME": "MXEBGVMI.BALANCE_DISPATCH",
					"SEGMENT_NAME": "STATUS",
					"P_KEY": oUpdateData
				};
				$.ajax({
