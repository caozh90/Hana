...
sap.ui.jsview("lenovo.view.vmi.execute.pullFromSupplier", {
	...
	setConfig: function(config, sServiceUrl,uServiceUrl,dSchema) {
		...
		config.upload = {
			...
			excelUrl: "vmi/control/pull_from_supplier.xlsx"
		};
	...
	_createContents: function(url, objects){
		...
		var i3PLId = new sap.ui.commons.ValueHelpField("i3PLId", {
			width: "142px",
			valueHelpRequest: function(oEvent){that._openSearchHelp(url, this);}
