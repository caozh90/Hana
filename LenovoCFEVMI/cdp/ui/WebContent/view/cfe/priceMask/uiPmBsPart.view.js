...
//main
/******Copy_Change_Start*******/
sap.ui.jsview("lenovo.view.cfe.priceMask.uiPmBsPart", { 
/******Copy_Change_End*******/	
	...
	createContent: function(){
		...
		/******Copy_Change_Start*******/
		var auth = lenovo.control.commontable.Table.getViewAuth("uiPmBsPart"); //ui_pm_bs_part
		/******Copy_Change_End*******/
	...
	setConfig: function(config, oServiceUrl, uServiceUrl, auth) {
		...
		//upload
		config.upload = {
			url: uServiceUrl + "/ui_pm_bs_part.xsjs",
