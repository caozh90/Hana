...
sap.ui.jsview("lenovo.view.szvmi.manage.soiFailedGR", {
	setConfig: function(config,sServiceUrl) {
		...
		config.download.table = '"_SYS_BIC"."cdp.szebgvmi.models/AT_SOI_GR"';
		...
		var oConfirmBtn = new sap.ui.commons.Button({
			...
			press: function(oEvent){
				...
				var oEntry = {
					...
					"PROCESS_NAME": "SOI_GR_RESUBMIT_SZ",
					"TABLE_NAME": "SZEBGVMI.SOI_GR",
					"SEGMENT_NAME": "STATUS",
					"P_KEY": oUpdateData
				};
				$.ajax({
