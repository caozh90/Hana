...
sap.ui.jsview("lenovo.view.szvmi.manage.linetoExcessFailedDispatches", {
	...
	setConfig: function(config, sServiceUrl) {
		...
		config.download.table = '"_SYS_BIC"."cdp.szebgvmi.models/AT_LINE_TO_EXCESS_FAILED_DISPATCHES"';
