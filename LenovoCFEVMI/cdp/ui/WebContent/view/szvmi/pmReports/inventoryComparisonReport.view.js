...
sap.ui.jsview("lenovo.view.szvmi.pmReports.inventoryComparisonReport", {
	...
	setConfig: function(config,sServiceUrl,uServiceUrl,dSchema) {
		...
		config.download.table = '"_SYS_BIC"."cdp.szebgvmi.models.pmreport/AN_INVENTORY_COMPARISON"';
		config.download.columns = ["MATNR","WERKS","LIFNR", "STORAGE_TYPE","STORAGE_BIN", "HOLD_TYPE","SYS_SOURCE","R3_TIMESTAMP","TPL_TIMESTAMP","R3_TIMESTAMP_DATE","R3_QTY","TPL_QTY","R3_TPL_DIFF"];
