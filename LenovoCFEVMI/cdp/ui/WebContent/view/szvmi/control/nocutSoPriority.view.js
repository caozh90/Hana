...
sap.ui.jsview("lenovo.view.szvmi.control.nocutSoPriority", {
	...
	setConfig: function(config,sServiceUrl,uServiceUrl,dSchema) {
		...
		config.download.table = '"_SYS_BIC"."cdp.szebgvmi.models/AT_UI_NOCUT_SO_PRIORITY"';
		...
		config.upload = {
			...
			excelUrl: "szvmi/control/nocut_so_priority.xlsx"
		};
