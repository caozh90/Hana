...
sap.ui.jsview("lenovo.view.szvmi.control.urgentMOMaintaince", {
	...
	setConfig: function(config, sServiceUrl, uServiceUrl,dSchema) {
		...
		config.download.table = '"_SYS_BIC"."cdp.szebgvmi.models/AT_URGENT_MO_MAINTENCE"';
		...
		config.upload = {
			...
			excelUrl: "szvmi/control/urgent_mo_maintaince.xlsx"
		};
	...
	createContent: function(oController) {
		...
		var oInvokeBtn = new sap.ui.commons.Button({
			...
			press: function(oEvent){
				var oEntry = {
					"JOB_TYPE": "running",
					"PROCESS_NAME": "URGENT_MO_PULL_SZ"
				};
				$.ajax({
					url: iServiceUrl + "/ui_urgent_mo_pull.xsjs",
					type: "POST",
