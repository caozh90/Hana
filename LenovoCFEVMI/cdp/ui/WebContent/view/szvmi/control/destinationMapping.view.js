...
sap.ui.jsview("lenovo.view.szvmi.control.destinationMapping", {
	...
	setConfig: function(config,sServiceUrl,uServiceUrl,dSchema) {
		...
		config.download.table = '"_SYS_BIC"."cdp.szebgvmi.models/AT_UI_LINE_FLOOR_MAPPING"';
		...
		config.upload = {
			...
			excelUrl: "szvmi/control/destination_mapping.xlsx"
		};
