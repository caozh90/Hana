...
sap.ui.jsview("lenovo.view.szvmi.DSworkflow.dsMonitor", {
	...
	createContent: function(oController) {
		...
		var sServiceUrl = "/cdp/dssz/services/tableview.xsodata";
	...
	_releaseService: function(sendData, table){
		...
		$.ajax({
			url: "/cdp/dssz/services/unlock.xsjs",
			type:"post",
			dataType: "text",
	...
	_reTrigger: function(oStepTable, jobName, processName, table){
		...
		sendData.JOB_NAME = jobName;
 		...
 		$.ajax({
			url: "/cdp/dssz/services/locked_check.xsjs",
			type:"post",
			dataType: "text",
			async: false,
	...
	_retriggerService: function(sendData, table){
		console.log(JSON.stringify(sendData));
		$.ajax({
			url: "/cdp/dssz/services/revoke_ds.xsjs",
			type:"post",
			dataType: "text",
			data: JSON.stringify(sendData),
			success: function(resp){
