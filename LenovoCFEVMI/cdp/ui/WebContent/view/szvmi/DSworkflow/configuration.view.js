...
sap.ui.jsview("lenovo.view.szvmi.DSworkflow.configuration", {
	...
	setConfig: function(config,config1,sServiceUrl) {
		...
		if(localStorage.MODULE_NAME == "SZEBGVMI"){
			var oTemp = {
				field: "FTP_TYPE",
				label: "Module",
				type: "DropdownBox",
			...
			config1.bindRowUrl = "/DS_FTP_INFO?$filter=FTP_TYPE eq 'SZEBGVMI'";
		}
