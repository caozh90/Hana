...
// copy and change
var role = 'ui_stdcost_daily::uploadable';


var json=JSON.parse($.request.body.asString());

//copy and change
var tableName = 'UI_STDCOST_DAILY';
...
function exception_process()
{
	...
	var info_sql = 'call "EBGCFE"."cdp.ebgcfe.procedures.pkg_ui.upload::ui_stdcost_daily_err"(?,?,?,?,?,?,?,?)';
	try 
	{
...
if(lib.assertAppRole(role)==='OK')
{
	...
	{  
		...
		query = 'CALL "EBGCFE"."cdp.ebgcfe.procedures.pkg_ui.upload::ui_stdcost_daily"(?,?,?,?,?,?,?)';
		try
		{
