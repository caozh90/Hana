...
/*	var info_sql = 'call "EBGCFE"."cdp.ebgcfe.procedures.pkg_ui.upload::ui_wwvar_err"(\''
		+error_message+'\',\''
		+fileName+'\',\''
	...
	try
	{
		...
		pcall2.setString(4,BRAND);
		pcall2.setString(5,FAMILY);
		pcall2.setString(6,PLANT);
		pcall2.setString(7,SUBGEO);
		pcall2.setString(8,ASSEMBLY);
		pcall2.setString(9,TBA_TYPE);
		pcall2.setString(10,M1);
		pcall2.setString(11,M2);
		pcall2.setString(12,M3);
		pcall2.setString(13,M4);
		pcall2.setString(14,M5);
		pcall2.setString(15,M6);
		pcall2.setString(16,M7);
		pcall2.setString(17,M8);
		pcall2.setString(18,M9);
		pcall2.setString(19,M10);
		pcall2.setString(20,M11);
		pcall2.setString(21,M12);
		pcall2.setString(22,M13);
		pcall2.setString(23,M14);
		pcall2.setString(24,M15);
		pcall2.setString(25,M16);
		pcall2.setString(26,M17);
		pcall2.setString(27,M18);	
		pcall2.setInteger(28,seq);
		pcall2.setInteger(29,position);	
...
if(lib.assertAppRole(role)==='OK')
{
	...
	for(i=0;i<data.length;i++)
	{
		...
		ASSEMBLY = lib.processData(data[i].ASSEMBLY);
		...
		if(TBA_TYPE === undefined ||BRAND === undefined ||PLANT === undefined||CYCLE === undefined)
		{
			error_message='not enough values';
			exception_process();
			continue;
		}
		else if(FAMILY === undefined ||SUBGEO === undefined ||ASSEMBLY === undefined)
		{
			error_message='not enough values';
			exception_process();
			continue;
		...
		if(ASSEMBLY.length>40)
		{
			error_message='ASSEMBLY::The length of "ASSEMBLY" is too large(no more than 40)';
			exception_process();
			continue;
		}
...
/*		query = 'CALL "EBGCFE"."cdp.ebgcfe.procedures.pkg_ui.upload::ui_wwvar"'
		    + '(\''
		...
		try
		{
			...
			pcall.setString(3,FAMILY);
			pcall.setString(4,PLANT);
			pcall.setString(5,SUBGEO);
			pcall.setString(6,ASSEMBLY);
			pcall.setString(7,TBA_TYPE);
			pcall.setString(8,M1);
			pcall.setString(9,M2);
			pcall.setString(10,M3);
			pcall.setString(11,M4);
			pcall.setString(12,M5);
			pcall.setString(13,M6);
			pcall.setString(14,M7);
			pcall.setString(15,M8);
			pcall.setString(16,M9);
			pcall.setString(17,M10);
			pcall.setString(18,M11);
			pcall.setString(19,M12);
			pcall.setString(20,M13);
			pcall.setString(21,M14);
			pcall.setString(22,M15);
			pcall.setString(23,M16);
			pcall.setString(24,M17);
			pcall.setString(25,M18);	
			pcall.setString(26,fileName);
			pcall.setInteger(27,seq);
			pcall.setInteger(28,position);
...
//	body = 'CALL "EBGCFE"."cdp.ebgcfe.procedures.pkg_ui.upload::ui_wwvar"'
//	    + '(\''
//
//		+ CYCLE+'\',\''
//		+ BRAND+'\',\''
