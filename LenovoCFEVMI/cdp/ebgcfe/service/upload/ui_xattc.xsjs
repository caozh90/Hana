...
/*	var info_sql = 'call "EBGCFE"."cdp.ebgcfe.procedures.pkg_ui.upload::ui_xattc_err"(\''
		+error_message+'\',\''
		+fileName+'\',\''
...
if(lib.assertAppRole(role)==='OK')
{
	...
	for(i=0;i<data.length;i++)
	{
		...
		/*query = 'CALL "EBGCFE"."cdp.ebgcfe.procedures.pkg_ui.upload::ui_xattc"'
		    + '(\''
