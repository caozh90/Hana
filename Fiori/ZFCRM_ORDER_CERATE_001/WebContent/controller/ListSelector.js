sap.ui.define([
	...
	return BaseObject.extend("Demo.model.ListSelector", {
		 ...
		 * @return {Demo.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
