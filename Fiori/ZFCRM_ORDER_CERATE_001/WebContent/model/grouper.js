sap.ui.define([], function() {
	...
	return {
		...
		/**
		 * Grouping function to group the master list by GrossValue
		 * @public
		 * @param {object} oContext the current list item context
		 * @returns {object} an object with the GrossValue as key and a text for the group headers
		 */
		GrossValue: function(oContext) {
			var iPrice = oContext.getProperty("GrossValue"),
				sKey,
				sText,
