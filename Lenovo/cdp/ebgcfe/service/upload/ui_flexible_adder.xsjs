...
//	var info_sql = 'call "EBGCFE"."cdp.ebgcfe.procedures.pkg_ui.upload::ui_flexible_adder_err"(\''
//		+error_message+'\',\''
//		+fileName+'\',\''
//		
//		+ CYCLE+'\',\''
...
if(lib.assertAppRole(role)==='OK')
{
	...
	for(i=0;i<data.length;i++)
	{
		...
		if(ADDER_NAME === undefined ||BRAND === undefined ||PLANT === undefined||CYCLE === undefined)
		{
...
/*		query = 'CALL "EBGCFE"."cdp.ebgcfe.procedures.pkg_ui.upload::ui_flexible_adder"'
		    + '(\''
