...
/*	var info_sql = 'call "EBGCFE"."cdp.ebgcfe.procedures.pkg_ui.upload::ui_xmva_err"(\''
		+error_message+'\',\''
		+fileName+'\',\''
...
if(lib.assertAppRole(role)==='OK')
{
	...
	/*	query = 'CALL "EBGCFE"."cdp.ebgcfe.procedures.pkg_ui.upload::ui_xmva"'
		    + '(\''
