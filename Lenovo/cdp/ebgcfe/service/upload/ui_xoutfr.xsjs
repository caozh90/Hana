...
/*	var info_sql = 'call "EBGCFE"."cdp.ebgcfe.procedures.pkg_ui.upload::ui_xoutfr_err"(\''
		+error_message+'\',\''
		+fileName+'\',\''
...
/*		query = 'CALL "EBGCFE"."cdp.ebgcfe.procedures.pkg_ui.upload::ui_xoutfr"'
		    + '(\''
