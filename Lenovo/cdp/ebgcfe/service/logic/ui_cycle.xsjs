...
var sessionID='';
var process_name='GEN_NEW_CYCLE';
...
if (assertAppRole('ui_cycle::executable') !== 'OK')
{
...
{
	/*0. get data from UI*/
	var cycle_name = String($.request.parameters.get("cycle_name"));
	var cycle_type = String($.request.parameters.get("cycle_type"));
	var cycle_cur_mon = String($.request.parameters.get("cycle_cur_mon"));
	var cycle_fcst_mon = String($.request.parameters.get("cycle_fcst_mon"));
	...
	else
	{
		...
		{	
			var run_body = '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" '
				  ...
				  +'\n'+'<variable name="G_CYCLE_NAME">'+cycle_name+'</variable>'
				  +'\n'+'<variable name="G_CYCLE_TYPE">'+cycle_type+'</variable>'
				  +'\n'+'<variable name="G_CYCLE_CUR_MON">'+cycle_cur_mon+'</variable>'
				  +'\n'+'<variable name="G_CYCLE_FCST_MON">'+cycle_fcst_mon+'</variable>'
				  //+'\n'+'<variable name="G_IN_PRODUCTGROUP">'+product_group+'</variable>'
				  /***************************************************************************/
