...
var role = 'ui_cto_cost_bom::deletable';


var json=JSON.parse($.request.body.asString());


var tableName = 'UI_CTO_DOWNLOAD';
var data = json.data;
var result="";
var error_message;
...
//{
	...
	if(success_result.length>0){
		try
		{
			var callProcedure = hconn.loadProcedure('EBGCFE', 'cdp.ebgcfe.procedures.pkg_ui.ui_cto_costbom::ui_cto_costbom_download_delete');
