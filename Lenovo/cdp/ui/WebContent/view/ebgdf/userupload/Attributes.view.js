 ...
 */
/************************************
* Created by bianzh1 at 2015-11-12
...
//main
/******Copy_Change_Start*******/
sap.ui.jsview("lenovo.view.ebgdf.userupload.Attributes", { 
/******Copy_Change_End*******/	
	...
	createContent: function(){
		...
		/******Copy_Change_Start*******/
		var auth = lenovo.control.commontable.Table.getViewAuth("Attributes");
		/******Copy_Change_End*******/
		...
		/******Copy_Change_Start*******/
		var header = lenovo.control.commontable.Table.createHeader("User Upload", "Attributes Upload");
		/******Copy_Change_End*******/
		
		//set data connection
		/******Copy_Change_Start*******/
		config.bindRowUrl = "/UI_ATTRIBUTES";
	...
	setConfig: function(config, oServiceUrl, uServiceUrl, auth) {	
		...
		{field: "BIZ_LINE", label: "BIZ_LINE", type:"TextField", width: "200px"},
		{field: "X_NAME", label: "X_NAME", type:"TextField", width: "200px"},
		...
		config.filtersRaw = [{
			...
			field: "BIZ_LINE", label: "BIZ_LINE", type: "TextField", 
			labelLayout: new sap.ui.layout.GridData({span: "L2 M2 S2", linebreak: true})
		},{
			field: "X_NAME", label: "X_NAME", type: "TextField", 
			labelLayout: new sap.ui.layout.GridData({span: "L2 M2 S2", linebreak: true})
		},{
			field: "PROJECT", label: "PROJECT", type: "TextField", 
			labelLayout: new sap.ui.layout.GridData({span: "L2 M2 S2", linebreak: true})
		}];
		/******Copy_Change_End*******/
		...
		config.create.url = "/UI_ATTRIBUTES";
		/******Copy_Change_End*******/
		/******Copy_Change_Start*******/
		//download
		config.download.table = '"_SYS_BIC"."cdp.ebgdf.models.ui_attributes/CV_UI_ATTRIBUTES"';
		config.download.columns=[
			"MT","BIZ_LINE","X_NAME","PROJECT","CREATE_TS","CREATE_USERID","LAST_UPDATE_TS","LAST_UPDATE_USERID"];

		config.download.filename= "attributes";
		/******Copy_Change_End*******/
		...
		//upload
		config.upload = {
			url: uServiceUrl + "/ui_attributes.xsjs",
			excelUrl: "ebgdf/attributes/Attributes.xlsx"
		};
		//status view
		config.viewstatus = {
				viewUploadHistory: {
					url: uServiceUrl + "/upload.xsodata",
					bindRowUrl: "/UPLOAD_BUSINESS_INFO?$filter=TABLE_NAME eq 'UI_MT_ATTRIBUTES'",
				...
				viewUploadErrorDetail: {
					url: uServiceUrl + "/upload.xsodata/UI_ATTRIBUTES_ERR_DETAIL?$format=json",
					columns: [[{
						field: "MT",
						label: "MT",
						type:  "TextField"
	...
	deleteAll: function(table){
		sap.ui.commons.MessageBox.confirm("Do you want to delete all items?", function(result){
			if(result){
				var service = new lenovo.service.EBGDF();
				var logicServiceUrl = service.getebgdfLogic();
				var table_name = "UI_MT_ATTRIBUTES";
				var obj = {
