...
sap.ui.jsview("lenovo.view.vmi.manage.loiFailedGR", {
	setConfig: function(config,sServiceUrl) {
		...
		config.download.table = '"_SYS_BIC"."cdp.mxebgvmi.models/AT_LOI_GR"';
		...
		var oConfirmBtn = new sap.ui.commons.Button({
			...
			press: function(oEvent){
				...
				var oEntry = {
					...
					"PROCESS_NAME": "LOI_GR_RESUBMIT",
					"TABLE_NAME": "MXEBGVMI.LOI_GR",
					"SEGMENT_NAME": "STATUS",
					"P_KEY": oUpdateData
				};
				$.ajax({
