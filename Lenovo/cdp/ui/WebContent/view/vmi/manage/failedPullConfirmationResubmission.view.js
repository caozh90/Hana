...
sap.ui.jsview("lenovo.view.vmi.manage.failedPullConfirmationResubmission", {
	...
	setConfig: function(config,sServiceUrl) {
		...
		config.download.table = '"_SYS_BIC"."cdp.mxebgvmi.models/AT_CLEAR_DIFF"';
		...
		var oInvokeBtn = new sap.ui.commons.Button({
			...
			press: function(oEvent){
				...
				var oEntry = {
					...
					"PROCESS_NAME": "RESUBMIT_CONFIRMED_PULL_TO_ECC",
					"TABLE_NAME": "MXEBGVMI.CLEAR_DIFF",
					"SEGMENT_NAME": "STATUS",
					"P_KEY": oUpdateData
				};
				$.ajax({
