...
sap.ui.jsview("lenovo.view.vmi.control.sourcingPriority", {
	setConfig: function(config,sServiceUrl,uServiceUrl,dSchema) {
		...
		config.upload = {
			...
			excelUrl: "vmi/control/sourcing_priority.xlsx"
		};
		...
		config.download.table = '"_SYS_BIC"."cdp.mxebgvmi.models/AT_SOURCE_PRIORITY"';
