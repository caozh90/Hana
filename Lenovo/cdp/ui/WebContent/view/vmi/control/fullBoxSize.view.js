...
sap.ui.jsview("lenovo.view.vmi.control.fullBoxSize", {
	...
	setConfig: function(config,sServiceUrl,uServiceUrl,dSchema) {
		...
		config.download.table = '"_SYS_BIC"."cdp.mxebgvmi.models/AT_UI_ITEM_FULL_BOX"';
		...
		config.upload = {
			...
			excelUrl: "vmi/control/full_box_size.xlsx"
		};
