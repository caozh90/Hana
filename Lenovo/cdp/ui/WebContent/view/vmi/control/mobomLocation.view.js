...
sap.ui.jsview("lenovo.view.vmi.control.mobomLocation", {
	...
	setConfig: function(config,sServiceUrl,uServiceUrl,dSchema) {
		...
		config.download.table = '"_SYS_BIC"."cdp.mxebgvmi.models.mobomLocation/AT_MOBOM_LOCATION"';
		...
		config.upload = {
			...
			excelUrl: "vmi/control/mobom_location.xlsx"
		};
