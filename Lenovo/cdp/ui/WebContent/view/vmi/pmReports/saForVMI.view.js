...
sap.ui.jsview("lenovo.view.vmi.pmReports.saForVMI", {
...
/*			type: "DropdownTable",
		...
		config.download.table = '"_SYS_BIC"."cdp.mxebgvmi.models.pmreport/AN_SA_FOR_VMI"';
	...
	createContent: function(oController) {
		...
		var header = lenovo.control.commontable.Table.createHeader("PM Reports", "SA for Mexico VMI");
		return [header, filterPanel, oInsertUpload, table];
	},

	onTreeNavigation: function(sChannel, sEvent, oData){
		if(oData.view === "SA for Mexico VMI") {
