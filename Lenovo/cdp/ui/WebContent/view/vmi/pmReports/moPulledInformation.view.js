...
sap.ui.jsview("lenovo.view.vmi.pmReports.moPulledInformation", {
	...
	setConfig: function(config,sServiceUrl,uServiceUrl,dSchema) {
		...
		config.download.table = '"_SYS_BIC"."cdp.mxebgvmi.models.pmreport/AN_MO_PULLED_INFORMATION"';
		config.download.columns = ["CANDYMAN_PULLS","PLAN_DATE","EXCESS_PULLS","FAMILY","LOGICAL_PLANT","MO_NO","MO_QTY","MRP_CONTROLLER","MTM","NORMAL_PULLS","ORDER_TYPE","PACKAGING_PULLS","PLAN_DATE","PRODUCTION_LINE","REMARK","SHIPPING_PULLS","SYS_TIMESTAMP","SYS_TIMESTAMP001","SYS_TIMESTAMP_T"];
