...
sap.ui.jsview("lenovo.view.vmi.pmReports.moCutbackMaterialReturnReport", {
	...
	setConfig: function(config,sServiceUrl,uServiceUrl,dSchema) {
		...
		config.download.table = '"_SYS_BIC"."cdp.mxebgvmi.models.pmreport/AN_MO_CUTBACK_MATERIAL_RETURN"';
