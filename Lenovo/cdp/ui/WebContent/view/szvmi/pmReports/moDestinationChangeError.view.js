...
sap.ui.jsview("lenovo.view.szvmi.pmReports.moDestinationChangeError", {
	...
	setConfig: function(config,sServiceUrl,uServiceUrl,dSchema) {
		...
		config.download.table = '"_SYS_BIC"."cdp.szebgvmi.models.pmreport/CV_MO_DESTINATION_CHANGE_ERROR"';
