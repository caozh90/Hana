...
sap.ui.jsview("lenovo.view.szvmi.monitor.pullLines", {
	...
	setConfig: function(config, sServiceUrl) {
		...
		var auth =  lenovo.control.commontable.Table.getViewAuth("pullLines");
		...
		config.download.table = '"_SYS_BIC"."cdp.szebgvmi.models/CV_PULL_LINE"';
		config.download.columns = ["PULL_HEADER_ID", "PULL_LINE_ID", "MATNR", "MATNR_DESCR", "CONFIRM_QTY", "PULL_QTY", "FULL_BOX_QTY", "SHIP_QTY", "STATUS", "SA_NUMBER", "WERKS", "DELIVERY_DATE", "HEADER_SUPPLIERID",
			...
			"DEST_STORAGE_BIN", "PRODUCTION_LINE", "PHYSICAL_PLANT", "INVENTORY_TYPE", "REMARK"
		];
	...
	createContent: function(oController) {
		...
		var header = lenovo.control.commontable.Table.createHeader("monitor", "pull lines");
