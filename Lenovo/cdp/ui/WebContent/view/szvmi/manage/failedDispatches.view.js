...
sap.ui.jsview("lenovo.view.szvmi.manage.failedDispatches", {
	...
	setConfig: function(config,sServiceUrl) {
		...
		config.download.table = '"_SYS_BIC"."cdp.szebgvmi.models.FailedDispatches/CV_DISPATCH_LIST"';
		...
		var oInvokeBtn = new sap.ui.commons.Button({
			...
			press: function(oEvent){
				...
				var oEntry = {
					...
					"PROCESS_NAME": "CONFIRMED_DISPATCH_P_SZ",
					"TABLE_NAME": "SZEBGVMI.DISPATCH_LIST",
					"SEGMENT_NAME": "STATUS",
					"P_KEY": oUpdateData
				};
				$.ajax({
