...
sap.ui.jsview("lenovo.view.szvmi.manage.failedPullResubmission", {
	...
	setConfig: function(config, sServiceUrl) {
		...
		config.download.table = '"_SYS_BIC"."cdp.szebgvmi.models/CV_FAILED_PULL_RESUBMISSION"';
		...
		var oInvokeBtn = new sap.ui.commons.Button({
			...
			press: function(oEvent){
				...
				var oEntry = {
					...
					"PROCESS_NAME": "RESUBMIT_PULL_TO_ECC_SZ",
					"TABLE_NAME": "SZEBGVMI.PULL_LINE",
					"SEGMENT_NAME": "STATUS",
					"P_KEY": oUpdateData
				};
				$.ajax({
