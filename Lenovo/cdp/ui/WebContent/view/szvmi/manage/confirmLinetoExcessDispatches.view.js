...
sap.ui.jsview("lenovo.view.szvmi.manage.confirmLinetoExcessDispatches", {
	...
	setConfig: function(config,sServiceUrl) {
		...
		config.download.table = '"_SYS_BIC"."cdp.szebgvmi.models/CV_CONFIRM_LINE_TO_EXCESS_DISPATCHES"';
		...
		var oInvokeBtn = new sap.ui.commons.Button({
			...
			press: function(oEvent){
				...
				var oEntry = {
					...
					"PROCESS_NAME": "LINE_TO_EXCESS_TO_ECC_SZ",
					"TABLE_NAME": "SZEBGVMI.SPECIAL_DISPATCH",
					"SEGMENT_NAME": "STATUS",
					"P_KEY": oUpdateData
				};
				$.ajax({
