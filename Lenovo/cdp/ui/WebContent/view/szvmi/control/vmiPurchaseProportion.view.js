...
sap.ui.jsview("lenovo.view.szvmi.control.vmiPurchaseProportion", {
	setConfig: function(config,sServiceUrl, uServiceUrl,iServiceUrl, dSchema) {
		...
		config.upload = {
			...
			excelUrl: "szvmi/control/vmi_purchase_proportion.xlsx"
		};
		...
		config.download.table = '"_SYS_BIC"."cdp.szebgvmi.models/AT_PURCHASE_PROPORTION"';
