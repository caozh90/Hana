/************************************************************************
*name       :      
*function   :call ds for ui_mfi_ppn_refresh
*input      ：
*output     :
*author     :bianzh1
...
if (assertAppRole('ui_mfi_ppn::executable') !== 'OK')
{
...
//	var family = String($.request.parameters.get("family"));
	...
	/*4 get DS job info*/
	query = 'select * from "_SYS_BIC"."cdp.dssz.models/AT_HANA_DS_JOB_INFO" where PROCESS_NAME=\''+process_name+'\'';
