...
/*	var info_sql = 'call "MXEBGVMI"."cdp.mxebgvmi.procedures.pkg_ui.upload::ui_urgent_mo_pull_err"(\''
		+error_message+'\',\''
		+fileName+'\',\''
...
if(lib.assertAppRole(role)==='OK')
{
	...
	for(i=0;i<data.length;i++)
	{
		...
		query = 'CALL "MXEBGVMI"."cdp.mxebgvmi.procedures.pkg_ui.upload::ui_urgent_mo_pull"'
		    + '(\''
			+logical_plant+'\',\''
			+mo_id+'\',\''
			+status+'\',\''
