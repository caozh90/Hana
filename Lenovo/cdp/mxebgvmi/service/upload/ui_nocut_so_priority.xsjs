...
/*	var info_sql = 'call "MXEBGVMI"."cdp.mxebgvmi.procedures.pkg_ui.upload::ui_nocut_so_priority_err"(\''
		+error_message+'\',\''
		+fileName+'\',\''
...
//		query = 'CALL "MXEBGVMI"."cdp.mxebgvmi.procedures.pkg_ui.upload::ui_nocut_so_priority"'
//		    + '(\''
//		    
//			+ LOGICAL_PLANT+'\','
//			+ DELIVERY_PRIORITY+',\''
...
//		    + ')';
		...
		//query = 'CALL "MXEBGVMI"."cdp.mxebgvmi.procedures.pkg_ui.upload::test"(?,?)';
		try
		{
