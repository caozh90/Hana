...
function validationBefore(param,oper_type){
    ...
    pStmt = param.connection.prepareCall('call "MXEBGVMI"."cdp.mxebgvmi.procedures.pkg_ui.ui_create_cycle_time::validationUiCreateCycleTime"(?,?,?,?,?,?)');
...
function insert(param){
    ...
    pStmt = param.connection.prepareCall('call "MXEBGVMI"."cdp.mxebgvmi.procedures.pkg_ui.ui_create_cycle_time::createUiCreateCycleTime"(?,?,?,?)');
	pStmt.setString(1,tpl_id);
	pStmt.setString(2,pull_type);
	pStmt.setString(3,entity_type);
...
function update(param){
    ...
    pStmt = param.connection.prepareCall('call "MXEBGVMI"."cdp.mxebgvmi.procedures.pkg_ui.ui_create_cycle_time::updateUiCreateCycleTime"(?,?,?,?)');
	pStmt.setString(1,tpl_id);
	pStmt.setString(2,pull_type);
	pStmt.setString(3,entity_type);
	pStmt.setDecimal(4,cycle_time);
...
function remove(param){
    ...
    pStmt = param.connection.prepareCall('call "MXEBGVMI"."cdp.mxebgvmi.procedures.pkg_ui.ui_create_cycle_time::deleteUiCreateCycleTime"(?,?,?,?)');
	pStmt.setString(1,tpl_id);
	pStmt.setString(2,pull_type);
	pStmt.setString(3,entity_type);
