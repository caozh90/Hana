...
{
	seq_query = 'call "MXEBGVMI"."cdp.mxebgvmi.procedures.pkg_ui.ui_manual_pull::generate_pull_header_id"(?)';
	...
	for(i=0;i<data.length;i++)
	{
		...
		query = 'CALL "MXEBGVMI"."cdp.mxebgvmi.procedures.pkg_ui.ui_manual_pull::createUiManualPull"'
			    + '(\''
			    + DEST_STORAGE_LOC+'\',\''
			    + DEST_STORAGE_TYPE+'\',\''
			    + DEST_STORAGE_BIN+'\',\''
