...
//	var info_sql = 'call "SZEBGVMI"."cdp.szebgvmi.procedures.pkg_ui.upload::ui_sourcing_priority_err"(\''
//		+error_message+'\',\''
//		+fileName+'\',\''
//
//		+logical_plant+'\',\''
...
if(lib.assertAppRole(role)==='OK')
{
	...
	for(i=0;i<data.length;i++)
	{
		...
		query = 'CALL "SZEBGVMI"."cdp.szebgvmi.procedures.pkg_ui.upload::ui_sourcing_priority"'
		    + '(\''
