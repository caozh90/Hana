...
/*	var info_sql = 'call "SZEBGVMI"."cdp.szebgvmi.procedures.pkg_ui.upload::ui_item_full_box_err"(\''
		+error_message+'\',\''
		+fileName+'\',\''
		+item+'\',\''
		+vendorid+'\',\''
...
/*		
		query = 'CALL "SZEBGVMI"."cdp.szebgvmi.procedures.pkg_ui.upload::ui_item_full_box"'
		    + '(\''
		    + item + '\',\''
		    + vendorid + '\',\''
		    + box_size + '\',\''
